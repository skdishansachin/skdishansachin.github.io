...
<template>
    <div
        class="relative flex items-center justify-center overflow-hidden py-12"
        @mouseover="fast = true"
    ...
    >
        ...
        animationDuration: streakSpeed,
            ...
            class="streak absolute left-0 h-0.5 w-1/5 bg-gradient-to-r from-transparent to-black/60"
        ></span>
    </div>
</template>
